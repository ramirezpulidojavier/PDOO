...
class CivitasJuego
  ...
  def ranking
    ...
    aux = @jugadores.at(0)<=>@jugadores.at(1)
    return aux
  ...
  def inicializar_mazo_sorpresas(tablero)
    ...
    ir_carcel = Sorpresa.new(tablero, TipoSorpresa::IRCARCEL)
 
    ir_casilla = Sorpresa.new(tablero, TipoSorpresa::IRCASILLA, 6, "Ve a la casilla numero 6")
    ir_casilla2 = Sorpresa.new(tablero, TipoSorpresa::IRCASILLA, 13, "Ve a la casilla numero 13")
  ...
  def avanza_jugador
        ...
        posicion_actual = @jugadores.at(@indice_jugador_actual).num_casilla_actual
