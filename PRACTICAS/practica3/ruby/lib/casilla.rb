...
class Casilla
  ...
  def informe(iactual,todos)
    ...
    Diario.instance.ocurre_evento("El jugador #{todos.at(iactual).nombre} ha caido en la casilla: #{to_s}")
  ...
  def to_s
    ...
    return "#{@nombre}, la carcel esta en la posicion #{@@carcel}, el importe es de #{@importe} y es de tipo #{@tipo}\n"
