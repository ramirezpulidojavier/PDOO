...
module Civitas
  ...
  class Jugador
    ...
    def self.jugador(nombre)
      self.new(nil, nombre, 0, false, @@Saldo_inicial, nil, nil)
    end
    protected
    ...
    def cancelar_hipoteca(ip)
        ...
        if(existe_la_propiedad(ip))
            ...
            if result
              ...
              Diario.instance.ocurre_evento("El jugador #{@nombre} deshipoteca la propiedad #{@propiedades.get(ip).nombre}") 
