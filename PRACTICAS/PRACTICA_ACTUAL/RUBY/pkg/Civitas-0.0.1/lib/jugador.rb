...
module Civitas
  class Jugador
    ...
    def to_s
      ...
      return "Jugador: "+ @nombre+" Casilla actual: "+@num_casilla_actual.to_s+" esta encarcelado?: "+@encarcelado.to_s+" puede comprar?: "+@puede_comprar.to_s+" Numero de propiedades: #{@propiedades.size} Saldo: "+@saldo.to_s
    end
    ...
    def modificar_saldo(cantidad)
      @saldo += cantidad
      Diario.instance.ocurre_evento("El jugador #{@nombre} aumenta su saldo")
      return true
    end
    ...
    def mover_a_casilla(numCasilla)
      if @encarcelado
        ...
        @puede_comprar = false
        Diario.instance.ocurre_evento("El jugador #{@nombre} se ha movido de casilla")
        return true
      end
    end
    ...
    def vender(ip)
      if @encarcelado
        ...
        if existe_la_propiedad(ip) && @propiedades[ip].vender(self)
            ...
            Diario.instance.ocurre_evento("El jugador #{@nombre} vendio una propiedad")
            return true
        end
        return false
      end
    ...
    def salir_carcel_tirando
      if Dado.instance.salgo_de_la_carcel
        @encarcelado = false
        Diario.instance.ocurre_evento("El jugador #{@nombre} logra salir de la carcel tirando")
        return true
      else
        return false
      end  
    ...
    def pasa_por_salida
      ...
      Diario.instance.ocurre_evento("El jugador #{@nombre} cobro el paso por salida")
      return true
    end
    ...
    def cancelar_hipoteca(ip)
      ...
      if(result)
        Diario.instance.ocurre_evento("El jugador "+@nombre.to_s+" cancela la hipoteca de la propiedad "+ip.to_s)
      end
    ...
    def hipotecar(ip)
      ...
      if(result)
        Diario.instance.ocurre_evento("El jugador "+@nombre.to_s+" hipoteca la propiedad "+ip.to_s)
      end
